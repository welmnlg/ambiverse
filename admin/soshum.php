                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-body">
                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <?php
                                                    $no = 0;
                                                    $result = mysqli_query($conn, "SELECT * FROM exam_category WHERE subtes = 'eko'");
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-body">
                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <?php
                                                    $no = 0;
                                                    $result = mysqli_query($conn, "SELECT * FROM exam_category WHERE subtes = 'geo'");
                                                    while ($row = mysqli_fetch_array($result)){
                                                        $no++;
                                                        ?>
                                                        <tr>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-body">
                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <?php
                                                    $no = 0;
                                                    $result = mysqli_query($conn, "SELECT * FROM exam_category WHERE subtes = 'sej'");
                                                    while ($row = mysqli_fetch_array($result)){
                                                        $no++;
                                                        ?>
                                                        <tr>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-body">
                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <?php
                                                    $no = 0;
                                                    $result = mysqli_query($conn, "SELECT * FROM exam_category WHERE subtes = 'sosio'");
                                                    while ($row = mysqli_fetch_array($result)){
                                                        $no++;
                                                        ?>
                                                        <tr>
