                                ...
                                <div class="accordion-item">
                                    ...
                                    <form action="dashboard.php?id=<?= $row['id']; ?>" method="post">
                                                <table class="table table-bordered table-responsive">
                                                    ...
                                                    <?php 
                                                    $i = 0;
                                                    $res=mysqli_query($conn, "SELECT * FROM exam_category WHERE subtes = 'eko' ORDER BY id DESC");
                                ...
                                <div class="accordion-item">
                                    ...
                                    <form action="dashboard.php?id=<?= $row['id']; ?>" method="post">
                                                <table class="table table-bordered table-responsive">
                                                    ...
                                                    <?php 
                                                    $i = 0;
                                                    $res=mysqli_query($conn, "SELECT * FROM exam_category WHERE subtes = 'geo' ORDER BY id DESC");
                                                    while($row = mysqli_fetch_array($res)){
                                                        $id = $row['id'];
                                                        $i++;
                                                        $res1 = mysqli_query($conn, "SELECT * FROM exam_results");
                                ...
                                <div class="accordion-item">
                                    ...
                                    <form action="dashboard.php?id=<?= $row['id']; ?>" method="post">
                                                <table class="table table-bordered table-responsive">
                                                    ...
                                                    <?php 
                                                    $i = 0;
                                                    $res=mysqli_query($conn, "SELECT * FROM exam_category WHERE subtes = 'sej' ORDER BY id DESC");
                                                    while($row = mysqli_fetch_array($res)){
                                                        $id = $row['id'];
                                                        $i++;
                                                        $res1 = mysqli_query($conn, "SELECT * FROM exam_results");
                                ...
                                <div class="accordion-item">
                                    ...
                                    <form action="dashboard.php?id=<?= $row['id']; ?>" method="post">
                                                <table class="table table-bordered table-responsive">
                                                    ...
                                                    <?php 
                                                    $i = 0;
                                                    $res=mysqli_query($conn, "SELECT * FROM exam_category WHERE subtes = 'sosio' ORDER BY id DESC");
                                                    while($row = mysqli_fetch_array($res)){
                                                        $id = $row['id'];
                                                        $i++;
                                                        $res1 = mysqli_query($conn, "SELECT * FROM exam_results");
