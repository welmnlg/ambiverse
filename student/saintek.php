                                ...
                                <div class="accordion-item">
                                    ...
                                    <form action="dashboard.php?id=<?= $row['id']; ?>" method="post">
                                                <table class="table table-bordered table-responsive">
                                                    ...
                                                    <?php 
                                                    $i = 0;
                                                    $res=mysqli_query($conn, "SELECT * FROM exam_category WHERE subtes = 'kim' ORDER BY id DESC");
                                ...
                                <div class="accordion-item">
                                    ...
                                    <form action="dashboard.php?id=<?= $row['id']; ?>" method="post">
                                                <table class="table table-bordered table-responsive">
                                                    ...
                                                    <?php 
                                                    $i = 0;
                                                    $res=mysqli_query($conn, "SELECT * FROM exam_category WHERE subtes = 'bio' ORDER BY id DESC");
                                                    while($row = mysqli_fetch_array($res)){
                                                        $id = $row['id'];
                                                        $i++;
                                                        $res1 = mysqli_query($conn, "SELECT * FROM exam_results");
                                ...
                                <div class="accordion-item">
                                    ...
                                    <form action="dashboard.php?id=<?= $row['id']; ?>" method="post">
                                                <table class="table table-bordered table-responsive">
                                                    ...
                                                    <?php 
                                                    $i = 0;
                                                    $res=mysqli_query($conn, "SELECT * FROM exam_category WHERE subtes = 'fis' ORDER BY id DESC");
                                                    while($row = mysqli_fetch_array($res)){
                                                        $id = $row['id'];
                                                        $i++;
                                                        $res1 = mysqli_query($conn, "SELECT * FROM exam_results");
                                ...
                                <div class="accordion-item">
                                    ...
                                    <form action="dashboard.php?id=<?= $row['id']; ?>" method="post">
                                                <table class="table table-bordered table-responsive">
                                                    ...
                                                    <?php 
                                                    $i = 0;
                                                    $res=mysqli_query($conn, "SELECT * FROM exam_category WHERE subtes = 'mat' ORDER BY id DESC");
                                                    while($row = mysqli_fetch_array($res)){
                                                        $id = $row['id'];
                                                        $i++;
                                                        $res1 = mysqli_query($conn, "SELECT * FROM exam_results");
